...
import { Volume2, Star, ChevronLeft, ChevronRight, PenTool } from "lucide-react";
import { Card } from "@/components/ui/Card";
import { Button } from "@/components/ui/Button";

// Mock vocabulary data
const vocabulary = [
  { id: 1, hanzi: "你好", pinyin: "nǐ hǎo", meaning: "hello", type: "verb", example: "你好吗？(How are you?)" },
  { id: 2, hanzi: "请", pinyin: "qǐng", meaning: "please (do something)", type: "verb", example: "请进。(Please come in.)" },
  { id: 3, hanzi: "问", pinyin: "wèn", meaning: "to ask", type: "verb", example: "我问一个问题。(I ask a question.)" },
  { id: 4, hanzi: "贵", pinyin: "guì", meaning: "honorable; expensive", type: "adj", example: "这个很贵。(This is very expensive.)" },
  { id: 5, hanzi: "姓", pinyin: "xìng", meaning: "surname", type: "noun/verb", example: "你贵姓？(What is your honorable surname?)" },
];
...
export default function LearnPage() {
  ...
  return (
    <div className="p-4 md:p-10 max-w-5xl mx-auto flex flex-col h-full min-h-[85vh]">
      <div className="mb-6">
        <h1 className="text-2xl font-bold capitalize">Chapter {String(params.chapterId).replace("chapter-", "")}</h1>
        <p className="text-muted-foreground">Master the vocabulary and grammar for this chapter.</p>
      </div>
              ...
              <Card key={word.id} className="flex flex-col p-5 hover:border-primary/50 transition-colors">
                ...
                <div className="mt-auto pt-4 border-t border-border">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xs font-semibold text-muted-foreground uppercase">{word.type}</span>
